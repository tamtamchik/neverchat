#foreverchat
> Chat that lasts forever... simple as that. Based on Dweet.io.

[![Build Status](https://travis-ci.org/tamtamchik/foreverchat.svg?branch=master)](https://travis-ci.org/tamtamchik/foreverchat) [![Dependency Status](https://david-dm.org/tamtamchik/foreverchat.svg)](https://david-dm.org/tamtamchik/foreverchat) [![devDependency Status](https://david-dm.org/tamtamchik/foreverchat/dev-status.svg)](https://david-dm.org/tamtamchik/foreverchat#info=devDependencies)
...
## Release History
 * 2014-05-14   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)